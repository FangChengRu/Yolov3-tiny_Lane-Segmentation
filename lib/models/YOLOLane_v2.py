...
class MCnet(nn.Module):
    def __init__(self, block_cfg, export, **kwargs):
...
def get_net(export=False, **kwargs):
    YOLOv3Lane = [
        ...
        [[19, 15], Detect, [1, [[10, 14, 23, 27, 37, 58], [81, 82, 135, 169, 344, 319]], [256, 512], export]],
    ...
    model = MCnet(m_block_cfg, export, **kwargs)
    return model
