            ...
            if config.TEST.PLOTS:
                if batch_i == 0:
                    for i in range(test_batch_size):
                        ...
                        da_seg_mask = torch.nn.functional.interpolate(da_seg_mask, (720, 1280),
                                                                      mode='bilinear')
                        ...
                        da_gt_mask = torch.nn.functional.interpolate(da_gt_mask, (720, 1280),
                                                                     mode='bilinear')
                        ...
                        ll_seg_mask = torch.nn.functional.interpolate(ll_seg_mask, (720, 1280), mode='bilinear')
                        ...
                        ll_gt_mask = torch.nn.functional.interpolate(ll_gt_mask, (720, 1280), mode='bilinear')
